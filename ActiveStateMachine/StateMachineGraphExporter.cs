...
{
    public static XDocument ExportGraphMl(string machineName, IEnumerable<State> states)
    {
    ...
    public static void SaveGraphMl(string machineName, IEnumerable<State> states, string filePath)
